...
public class AnimationUtils {
     ...
     * @return
     */
    public static TimeInterpolator createInterpolator(@IntRange(from = 0, to = 10)
    ...
    public static ObjectAnimator createRotateAnimator(final View target, final float from, final float to) {
        ...
        animator.setInterpolator(TimeInterpolatorUtils.createInterpolator(LINEAR_INTERPOLATOR));
        return animator;
    }
}
